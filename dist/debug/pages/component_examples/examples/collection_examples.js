    ...
    return (_jsx(ExampleStack, { children: _jsxs(ExampleBlock, { description: "\u5B8C\u6574\u8986\u76D6\u5BFC\u822A\u3001\u5F00\u5173\u3001\u5355\u9009\u3001Select \u4E0E\u5E73\u53F0\u539F\u751F picker \u53D8\u4F53\u3002", title: "\u5DE5\u4F5C\u533A\u8BBE\u7F6E", children: [_jsx(Switch, { checked: native, label: "\u4F7F\u7528\u539F\u751F List \u5916\u89C2", labelPosition: "end", onCheckedChange: (nextNative) => {
                        ...
                        setNative(nextNative);
                                    ...
                                    ["never", "从不"],
                                            ...
                                            placeholder: "选择主题模式",
                                            value: theme ?? undefined,
                                        }, title: "Android Dialog" })) : null] })] }, native ? "native-list" : "fallback-list")) : null }), _jsxs(Text, { opacity: 0.6, children: ["\u6700\u8FD1\u52A8\u4F5C\uFF1A", lastAction, " \u00B7 \u81EA\u52A8\u540C\u6B65\uFF1A", autoSyncEnabled ? "开启" : "关闭", " \u00B7 \u4E3B\u9898\uFF1A", theme ?? "未选择", " \u00B7 \u9891\u7387\uFF1A", syncInterval ?? "未选择", " \u00B7 \u5907\u4EFD\uFF1A", backupInterval] })] }) }));
}
