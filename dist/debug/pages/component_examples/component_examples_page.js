...
import { NativeList, NativeListNavigationItem, NativeListSection, NativeSheetFillContent, NativeSheetScrollContent, ScrollView, Text, isIos26Plus, useAppBackgroundColors, } from "rn_ui_kit/core";
...
export function RnUiKitComponentExamplesDebugPage({ header, layoutHost = "default", }) {
    ...
    const pageBackgroundColor = layoutHost === "nativeSheet" && isIos26Plus()
        ? "transparent"
