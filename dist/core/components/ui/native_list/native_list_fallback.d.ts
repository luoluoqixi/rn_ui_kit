...
export declare function NativeListRoot({ backgroundColor, children, contentContainerStyle, contentMarginBottom, contentMarginTop, fixesIOS26NestedScrollIndicatorSafeArea: _fixesIOS26NestedScrollIndicatorSafeArea, initialScrollTarget, native: _native, scrollable, style, tracksNavigationBarScrollEdge: _tracksNavigationBarScrollEdge, ...rest }: NativeListRootProps): import("react").JSX.Element;
