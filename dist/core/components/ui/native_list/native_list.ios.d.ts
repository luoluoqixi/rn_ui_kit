...
declare function NativeListRoot({ automaticallyAdjustsScrollIndicatorInsets, backgroundColor, children, contentInsetAdjustmentBehavior, contentMarginBottom, contentMarginTop, fixesIOS26NestedScrollIndicatorSafeArea, initialScrollTarget, native, nestedScrollEnabled, scrollIndicatorInsets, style, scrollable, tracksNavigationBarScrollEdge, ...fallbackProps }: NativeListRootProps): import("react").JSX.Element;
