...
function NativeListRoot({ automaticallyAdjustsScrollIndicatorInsets, backgroundColor, children, contentInsetAdjustmentBehavior, contentMarginBottom, contentMarginTop, fixesIOS26NestedScrollIndicatorSafeArea, initialScrollTarget, native = true, nestedScrollEnabled, navigationBarScrollEdgeOptions, scrollIndicatorInsets, style, scrollable = true, tracksNavigationBarScrollEdge, ...fallbackProps }) {
    ...
    return (_jsx(NativeListContext.Provider, { value: { native: true }, children: _jsx(Host, { style: [styles.nativeRoot, style], children: _jsx(List
            ...
            , { 
                ...
                compensatesForViewportClipping: compensatesForTrueSheetViewportClipping, correctsNestedScrollIndicatorFrame: isIos26Plus() && fixesIOS26NestedScrollIndicatorSafeArea === true, initialScrollAnchor: "center", initialScrollTarget: initialScrollTarget, modifiers: [
