...
export type ToastVariantFunc = (title: TitleToast, options?: Omit<ToastShowOptions, "variant">) => string | number;
export type ToastCustomFunc = (jsx: (id: string | number) => React.ReactElement, data?: ToastShowOptions) => string | number;
export type ToastPromiseFunc = <ToastData>(promise: PromiseT<ToastData>, data?: ToastPromiseData<ToastData>) => (string & {
