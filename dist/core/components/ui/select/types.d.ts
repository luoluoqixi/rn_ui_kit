...
export type SelectWebMenuPlacement = "top" | "top-start" | "top-end" | "bottom" | "bottom-start" | "bottom-end" | "left" | "left-start" | "left-end" | "right" | "right-start" | "right-end";
export interface SelectProps extends Omit<ComponentProps<typeof TamaguiSelect>, "children" | "native" | "onValueChange"> {
    "aria-label"?: string;
    children?: ReactNode;
