...
export function NativeSlider(props) {
    const { value, onValueChange, min, max, step: stepProp, colors: colorsProp, nativeHaptics, nativeHapticsInterval, } = props;
    ...
    return (_jsx(Host, { style: { height: 48, width: "100%", justifyContent: "center" }, children: _jsx(ExpoSlider, { value: currentValue, onValueChange: handleValueChange, min: safeMin, max: safeMax, steps: resolvedSteps, colors: resolvedColors }) }));
}
