 ...
 */
export const NativeSheetScrollContent = forwardRef(({ bindToNativeSheet = false, children, contentContainerStyle, extraBottomPadding, navigationBarScrollEdgeOptions, style, tracksNavigationBarScrollEdge, ...rest }, ref) => {
