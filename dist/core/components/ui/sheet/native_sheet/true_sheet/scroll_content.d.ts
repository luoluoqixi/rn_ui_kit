...
export type TrueSheetScrollContentProps = Omit<ScrollViewProps, "children"> & NavigationBarScrollEdgeTrackingProps & {
    children: ReactNode;
    /** 追加在底部安全区与默认留白之后 */
 ...
 */
export declare const TrueSheetScrollContent: import("react").ForwardRefExoticComponent<Omit<ScrollViewProps, "children"> & NavigationBarScrollEdgeTrackingProps & {
    children: ReactNode;
    /** 追加在底部安全区与默认留白之后 */
    extraBottomPadding?: number;
    contentContainerStyle?: StyleProp<ViewStyle>;
