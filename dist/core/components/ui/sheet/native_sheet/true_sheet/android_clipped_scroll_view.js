 ...
 */
export const AndroidClippedScrollView = forwardRef(({ children, navigationBarScrollEdgeOptions, onContentSizeChange, onLayout, onMomentumScrollBegin, onMomentumScrollEnd, onScroll, onScrollBeginDrag, onScrollEndDrag, scrollEventThrottle, showsVerticalScrollIndicator = true, tracksNavigationBarScrollEdge = false, ...props }, forwardedRef) => {
