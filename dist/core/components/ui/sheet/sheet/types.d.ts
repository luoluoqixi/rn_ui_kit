...
export interface SheetProps extends Omit<ComponentProps<typeof ReplicaSheetModule.Sheet>, "native"> {
    content?: ReactNode;
...
export type SheetControllerProps = ComponentProps<typeof ReplicaSheetControllerModule.SheetController>;
