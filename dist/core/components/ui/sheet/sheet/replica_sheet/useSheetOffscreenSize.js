export const useSheetOffscreenSize = ({ snapPoints, position, screenSize, 
// frameSize,
snapPointsMode, }) => {
    ...
    const maxSize = typeof maxSnapPoint === "string"
        ? (Number(maxSnapPoint.slice(0, -1)) / 100) * screenSize
        : maxSnapPoint;
    const currentSnapPoint = snapPoints[position] ?? 0;
    const currentSize = typeof currentSnapPoint === "string"
