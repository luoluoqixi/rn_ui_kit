 ...
 */
export function useSheetScrollViewGestures({ scrollBridge, hasScrollableContent, scrollEnabled, setScrollEnabled, allowSheetDragOnScrollEdge, }) {
    const state = useRef({
        lastPageY: 0,
        dragAt: 0,
        dys: [],
    ...
    const onResponderMove = (e) => {
        ...
        const effectiveAllowSheetDragOnScrollEdge = allowSheetDragOnScrollEdge && !scrollBridge.isScrollIndicatorGestureActive;
