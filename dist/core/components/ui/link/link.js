...
export const Link = forwardRef((props, ref) => {
    ...
    const { focusVisibleStyle, hoverStyle, pressStyle, textDecorationColor, href, target, rel, nativeHaptics, onPress, ...linkProps } = props;
    ...
    if (isWeb()) {
        return (_jsx(TamaguiAnchor, { ...linkProps, href: href, target: target, rel: rel, ref: ref, ...anchorStyleProps, hoverStyle: {
    ...
    if (os() === "android") {
        return (_jsx(TamaguiAnchor, { ...linkProps, accessibilityRole: "link", ...anchorStyleProps, onPress: handlePress, pressStyle: resolvedPressStyle, ref: ref, self: "flex-start" }));
    }
    return (_jsx(View, { ref: ref, accessibilityRole: "link", self: "flex-start", onPress: handlePress, onPressIn: () => setPressed(true), onPressOut: () => setPressed(false), opacity: pressed ? resolvedPressStyle.opacity : 1, children: _jsx(TamaguiAnchor, { ...linkProps, ...anchorStyleProps, pointerEvents: "none", textDecorationColor: pressed
